...
class EcommereInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Install dummy data for the Ecommerce Aplication';
    ...
    protected function proceed()
    {
        ...
        $copySuccess = File::copyDirectory(public_path('assets/images/product'), public_path('storage/products/dummy'));
        if ($copySuccess) {
